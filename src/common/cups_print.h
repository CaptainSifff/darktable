...
// given the page settings (media size and border) and the printer (hardware margins) returns image and printable area
// layout in the area_width and area_height:
...
void dt_get_image_layout(const int32_t imgid, const dt_print_info_t *prt, const int32_t area_width, const int32_t area_height,
